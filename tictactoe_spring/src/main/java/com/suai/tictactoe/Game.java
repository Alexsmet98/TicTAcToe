...
public class Game {
    ...
    public static void addShutdownHook(String name, UserAction userAction) {
    ...
    public static void waitCoord(ConsoleInterface interfaceOfBoard, Board board,
    ...
    public static void transferOfCoordinates(ConsoleInterface interfaceOfBoard, WebSocketAction socket,
        ...
        while (true) {
            ...
            if (mark == 'X') {
                coordinates = interfaceOfBoard.getCoordinates(board);
    ...
    public static void runGame(ConsoleInterface interfaceOfBoard, UserAction userAction,
